<template>
	<header class="header">
		...
		<div class="text">
			...
			<svg class="pattern-circles" xmlns="http://www.w3.org/2000/svg" width="146" height="145">
